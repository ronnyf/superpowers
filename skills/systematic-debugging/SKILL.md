...
1. **Reproduce Consistently** — If not reproducible, gather more data. Don't guess.
...
|-------|---------------|------------------|
| **1. Root Cause** | Reproduce, gather evidence, trace data flow | Understand WHAT and WHY |
| **2. Hypothesis** | Form theory, test minimally | Confirmed or new hypothesis |
| **3. Implementation** | Create test, fix, verify | Bug resolved, tests pass |
...
**Related skills:**
- **superpowers:test-driven-development** - For creating failing test case (Phase 3)
